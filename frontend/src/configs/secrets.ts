...
export const DEFAULT_AVATAR: string | undefined = process.env.REACT_APP_S3_DEFAULT_IMAGE
export const TOKEN_SECRET: string | undefined = process.env.REACT_APP_ACCESS_TOKEN_SECRET
